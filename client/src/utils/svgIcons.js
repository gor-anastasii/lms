...
export const svgIconNow = () => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className="lucide lucide-circle-pause text-primary animate-spin-once">
...
export const svgIconSoon = () => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className="lucide lucide-circle-play text-muted-foreground">
    <circle cx="12" cy="12" r="10"></circle>
    <polygon points="10 8 16 12 10 16 10 8"></polygon>
  </svg>
);

export const svgIconArrow = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="16"
    height="16"
...
export const svgIconGarbage = () => (
  <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M11 9V15M7 9V15M3 5V17C3 17.5304 3.21071 18.0391 3.58579 18.4142C3.96086 18.7893 4.46957 19 5 19H13C13.5304 19 14.0391 18.7893 14.4142 18.4142C14.7893 18.0391 15 17.5304 15 17V5M1 5H17M4 5L6 1H12L14 5"
      stroke="#737373"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
